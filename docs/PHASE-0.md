...
| Content safety | Raw/SVG/HTML/attachment downloads are attachments with `nosniff` and sandboxing; clients do not render/open them. | 🟡 Partial — local active-content tests and a live binary attachment passed; live HTML/SVG remains. |
